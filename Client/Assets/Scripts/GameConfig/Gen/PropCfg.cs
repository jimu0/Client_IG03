...
public sealed partial class PropCfg : Luban.BeanBase
{
    public PropCfg(JSONNode _buf) 
    {
        ...
        { var __json0 = _buf["exchange_list"]; if(!__json0.IsArray) { throw new SerializationException(); } ExchangeList = new System.Collections.Generic.List<ItemExchange>(__json0.Count); foreach(JSONNode __e0 in __json0.Children) { ItemExchange __v0;  { if(!__e0.IsObject) { throw new SerializationException(); }  __v0 = ItemExchange.DeserializeItemExchange(__e0);  }  ExchangeList.Add(__v0); }   }
    ...
    public static PropCfg DeserializePropCfg(JSONNode _buf)
    {
